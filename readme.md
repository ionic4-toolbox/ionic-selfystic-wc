...
"Selfystic" is an app to capture and share selfies/groupies with your social networks. A cross-platform app using [Stencil]() + [Capacitor]() and [Ionic]() [Native Web Components]() version.

## Features

* [`@ionic/core`](https://ionicframework.com/pwa/toolkit) for the UI
* [Capacitor]() for the mobile platform support
...
2. Install a recent version of [GitBash]()
2. Install a recent version of [TypeScript]()
3. Checkout the code and install dependencies
```bash
git clone https://github.com/kosalanuwan/ionic-selfystic-wc
cd ionic-selfystic-wc
npm install
```

## Debugging

Selfystic has multi-processor architecture and the code is executed in different processes:
...
Selfystic can be packaged to Android and other [platforms that supports Capacitor]().
